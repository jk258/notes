import{d as z,p as x,c as e,o as i,N as o,j as a,F as c,B as p,n as O,_ as W,C as _,G as b,a as k,w as m,k as y}from"./chunks/framework.C-Bog4j8.js";import{R as B}from"./chunks/index.CE6Py4t8.js";const J=`<script setup lang="ts">\r
...
`,L={class:"box"},C={class:"col-box"},U=["onClick"],N=z({__name:"checkerboard",setup(f){const t=x({num:20,padding:20,size:20,lineWidth:1}),s=x({width:t.value.size*t.value.num,height:t.value.size*t.value.num}),l=x(new Array(t.value.num+1).fill(0).map((u,d)=>({x:d+1,yList:new Array(t.value.num+1).fill(0).map((r,n)=>({y:n+1,status:""}))})));let h="black";const g=(u,d)=>{l.value[u].yList[d].status=h,h=h==="black"?"white":"black"};return(u,d)=>(i(),e("div",{class:"box-padd",style:o({padding:t.value.padding+"px",width:s.value.width+"px",height:s.value.height+"px"})},[a("div",L,[(i(!0),e(c,null,p(t.value.num,(r,n)=>(i(),e("div",{class:"row",style:o({height:t.value.size+"px",borderBottom:t.value.lineWidth+"px solid #000",borderTop:n==0?t.value.lineWidth+"px solid #000":""}),key:r},null,4))),128)),a("div",C,[(i(!0),e(c,null,p(t.value.num,(r,n)=>(i(),e("div",{class:"col",style:o({width:t.value.size+"px",borderRight:t.value.lineWidth+"px solid #000",borderLeft:n==0?t.value.lineWidth+"px solid #000":""}),key:r},null,4))),128))]),a("div",{class:"piece-box",style:o({width:s.value.width+t.value.size-t.value.lineWidth*2+"px",height:s.value.height+t.value.size-t.value.lineWidth*2+"px",top:-t.value.size/2+t.value.lineWidth+"px",left:-t.value.size/2+t.value.lineWidth+"px"})},[(i(!0),e(c,null,p(l.value,(r,n)=>(i(),e("div",{class:"piece-row",style:o({marginBottom:n<l.value.length-1?t.value.lineWidth*2+"px":0}),key:r.x},[(i(!0),e(c,null,p(r.yList,(v,w)=>(i(),e("div",{class:O(["piece-col",v.status?v.status:""]),style:o({width:t.value.size-t.value.lineWidth*2+"px",height:t.value.size-t.value.lineWidth*2+"px",marginRight:n<l.value.length-1?t.value.lineWidth*2+"px":0}),onClick:V=>g(n,w),key:v.y},null,14,U))),128))],4))),128))],4)])],4))}}),S=W(N,[["__scopeId","data-v-4a7d7528"]]),T=JSON.parse('{"title":"棋盘","description":"","frontmatter":{},"headers":[],"relativePath":"前端/3-1-示例/棋盘.md","filePath":"前端/3-1-示例/棋盘.md"}'),R={name:"前端/3-1-示例/棋盘.md"},Z=Object.assign(R,{setup(f){return(t,s)=>{const l=_("ClientOnly");return i(),e("div",null,[s[0]||(s[0]=a("h1",{id:"棋盘",tabindex:"-1"},[k("棋盘 "),a("a",{class:"header-anchor",href:"#棋盘","aria-label":'Permalink to "棋盘"'},"​")],-1)),b(l,null,{default:m(()=>[b(y(B),{title:"",description:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",visible:!0,vueCode:y(J)},{vue:m(()=>[b(S)]),_:1},8,["vueCode"])]),_:1})])}}});export{T as __pageData,Z as default};
